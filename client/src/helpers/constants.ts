...
export const REPOSITORY = {
    URL: 'https://github.com/fcchbjm/AdGuardHome',
    TRACKERS_DB: 'https://github.com/fcchbjm/AdGuardHome/tree/master/client/src/helpers/trackers/trackers.json',
    ISSUES: 'https://github.com/fcchbjm/AdGuardHome/issues/new/choose',
};

export const CLIENT_ID_LINK = 'https://github.com/fcchbjm/AdGuardHome/wiki/Clients#clientid';
export const MANUAL_UPDATE_LINK = 'https://github.com/fcchbjm/AdGuardHome/wiki/FAQ#manual-update';
export const PORT_53_FAQ_LINK = 'https://github.com/fcchbjm/AdGuardHome/wiki/FAQ#bindinuse';
...
export const UPSTREAM_CONFIGURATION_WIKI_LINK =
    'https://github.com/fcchbjm/AdGuardHome/wiki/Configuration#upstreams';
